...
<div id="main" class="col-md-9">
    ...
    <div class="store-filter clearfix">
        <div class="pull-left">
            ...
            <div class="sort-filter">
                ...
                <select class="select input">
                    ...
                    <option value="2">DSC Price</option>
                </select>
                <a href="#" class="sort-by main-btn icon-btn"><i class="fa fa-arrow-down"></i></a>
            </div>
        </div>
        ...
        <div class="pull-right">
            ...
            <ul class="store-pages">
                ...
                <?php $indice = 0; ?>
                <?php for($paginacao=0; $paginacao < count($todosItensDecoded) / 9; $paginacao++, $indice += 9 ) : ?>
    ...
    <div id="store">
        ...
        <?php $count = 1; ?>
        <?php foreach ( $todosItensDecoded as $value ) : ?>
            <!-- Product Single -->
            <div class="produto col-md-4 col-sm-6 col-xs-6" id="product_<?= $value->id ?>" style="<?= $count > 9 ? 'display: none' : '' ?>">
                <div class="product product-single">
                    <div class="product-thumb">
                        ...
                        <a href="#"><button id="<?= $value->id ?>" class="main-btn quick-view"><i class="fa fa-search-plus"></i>Quick view</button></a>
