				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="login" name="login" class="form-control" id="login" value="<?= $funcionario->getLogin(); ?>">
						</div>
						<div class="form-group">
						...
						<div>
							...
							<select name="permissao" id="permissao" class="form-control">
								<?php foreach ($permissoes as $key => $value) : ?>
									<option value="<?= $value->getId() ?>" <?php if ( $value->getId() == $funcionario->getIdPermissao() ) echo "selected"; ?> > 
										<?= $value->getHierarquia();  ?>
									 </option>
								<?php endforeach ?>
							</select>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="nome" class="form-control" id="nome" value="<?= $funcionario->getNome(); ?>">
						</div>
						<div class="form-group">
							<label for="salario">Salario:<span class="requerido">*</span></label>
							<input type="text" name="salario" class="form-control" id="salario" value="<?= $funcionario->getSalario(); ?>">
						</div>
						<div>
							<label for="departamento">Departamento:<span class="requerido">*</span></label>
							<select name="departamento" id="departamento" class="form-control">
								<?php foreach ($departamentos as $key => $value) :?>
									<option value="<?= $value->getId() ?>" <?php if ($value->getId() == $funcionario->getIdDepartamento() ) echo "selected" ?>> 
										<?= $value->getNome() ?> 
									</option>
								<?php endforeach ?>
							</select>
